...
rel_data.BA = extractfield(BA_results, group);
if iscell(rel_data.BA)
    rel_data.BA = rel_data.BA{1,1};
end
rel_data.stats = extractfield(stats, group);
if iscell(rel_data.stats)
    rel_data.stats = rel_data.stats{1,1};
end
