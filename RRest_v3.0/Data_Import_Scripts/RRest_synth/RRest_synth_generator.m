...
switch mod
    case 'bw'
        mod_data.v = unmod_data.v + up.a_r*cos(w_r*unmod_data.t);
        mod_data.t = unmod_data.t;
    case 'am'
        %mod_data.v = detrend(unmod_data.v).*((1/up.a_r)+cos(w_r*unmod_data.t)); (old)
...
% Save to file
save([up.analysispath, 'RRSYNTH_data'], 'data')
